...
//        entityManager.getTransaction().begin();
//        int bankID = (Integer) entityManager.createNativeQuery("SELECT id FROM banks WHERE name=:bankName")
//                .setParameter("bankName", "Kreschatyk")
//                .getSingleResult();
//        entityManager.getTransaction().commit();
//
...
//        entityManager.getTransaction().begin();
//        Query q = entityManager.createNamedQuery("myQuery");
...
//        entityManager.getTransaction().begin();
//        Query q = entityManager.createNamedQuery("myNameQuery", Human.class);
